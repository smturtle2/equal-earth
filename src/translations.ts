export const translations = {
  en: {
    ...
    globeGrid: 'Graticule globe with N and S pole markers. Rotates with the map. Drag or use arrow keys to rotate; Q and E to roll.',
    ...
    presetNames: { default: 'Balanced', asia: 'Asia', europe: 'Europe', africa: 'Africa', northAmerica: 'N. America', southAmerica: 'S. America', oceania: 'Oceania', northPole: 'North Pole', southPole: 'South Pole' },
  ...
  ko: {
    ...
    globe: '동기화된 지구본',
    globeLayers: '지구본 레이어',
    globeGrid: 'N과 S로 극을 표시한 위도·경도 지구본. 지도와 함께 회전합니다. 드래그 또는 방향키로 회전, Q와 E로 비틀기.',
    globeMap: '지도 텍스처 지구본. 지도와 함께 회전합니다. 드래그 또는 방향키로 회전, Q와 E로 비틀기.',
    controls: '조작법',
    navigation: '지도 중심',
    presets: '프리셋',
    presetChoose: '프리셋',
    presetNames: { default: '균형', asia: '아시아', europe: '유럽', africa: '아프리카', northAmerica: '북아메리카', southAmerica: '남아메리카', oceania: '오세아니아', northPole: '북극', southPole: '남극' },
